! function(t) {
    ...
    var s = function(e, n) {
            ...
            s.append('<div class="month-label">' + e.format("MMMM YYYY") + "</div>"), s.append('<div class="calendar-actions"></div>'), t(".calendar-actions", s).append('<button type="button" class="prev">Previous</button> '), t(".calendar-actions", s).append('<button type="button" class="next">Next</button> '), t(".calendar-actions", s).append('<button type="button" class="today">Today</button> '), a.append(s);
            for (var r = t('<div class="month-weeks"></div>'), v = t('<div class="week week-header"><div class="days-container"></div></div>'), u = 0; u < 7; u++) t(".days-container", v).append('<div class="day ' + moment().day(u).format("dddd").toLowerCase() + '">' + moment().day(u).format("dddd") + "</div>");
            r.append(v);
        ...
        d = function(e) {
            var n = t('<a class="event ' + e["class"] + '" href="javascript:;"' + ("" != e.color ? 'style="border-color: ' + e.color + ';"' : "") + "></a>");
